...
<div class="back">
 ...
 <ul class="listOfProducts">
   ...
   <p align="center"> <q-btn color="green" @click="goBack()" >Go Back</q-btn></p>
  <div style="background-color:	#DCDCDC; padding-top: 2px; padding-bottom:7px">
  </div>
  </div>
</template>
   ...
   methods:{
        ...
        ...mapActions(["addFoodItem","addFoodInfo","removeFoodItem"]),
          addProductToCart(item) {
            if(this.counter!=0 && this.flag==0)
              this.counter=getCart
              this.flag=1
             this.counter+=1
